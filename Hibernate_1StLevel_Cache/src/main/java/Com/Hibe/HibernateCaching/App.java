...
public class App 
{
 ...
 //	EXAMPE FOR 1ST LEVEL CACHE :
    	 ...
    	 * ==> 	IN THE BELOW EXAMPLE EVENTHOUGH WE ARE GETTING THE DETAILS OF CMPNY WITH ID 10, 
    	   ...
    	   ==> NO MATTER UR IN WHICH SESSION IF U WANT TO REUSE THE QUERY THAT U FIRED ONCE IN UR APPLICATION 
    	 	   THEN GO FOR SECOND LEVEL CACHE WHICH WILL STORE THE DATA WITH IN UR APPLICATION . */
